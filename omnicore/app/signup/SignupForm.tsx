      ...
      <AnimatePresence mode="wait">
        {state.checkEmail ? (
          ...
          >
            ...
            <Link
              href="/login"
              className="mt-6 inline-block rounded-md border-2 border-ink bg-marigold px-4 py-2.5 font-bold shadow-[3px_3px_0_0_#1E3A8A] transition hover:-translate-y-0.5"
            >
              Go to sign in
            </Link>
          </motion.div>
